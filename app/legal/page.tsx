...
export const metadata: Metadata = {
  ...
  description: 'Transparency & Trust. Understand your rights and our responsibilities.',
};
        ...
        <main className="flex-grow flex flex-col items-center w-full px-4 sm:px-6 lg:px-8">
          ...
          <div className="w-full max-w-[800px] flex flex-col items-center text-center mb-12">
            ...
            <div className="w-14 h-14 rounded-2xl bg-primary/10 flex items-center justify-center mb-6">
              <span className="material-icons text-3xl text-primary">gavel</span>
            </div>
            ...
            <p className="text-xl text-muted-foreground mb-8">
              We believe in building a civic platform rooted in clarity. Understand your rights, our responsibilities, and how we protect your data.
            </p>
          </div>
