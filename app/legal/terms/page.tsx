...
export const metadata: Metadata = {
  ...
  description: 'Understand the rules and regulations governing the use of the Wihda platform.',
};
        ...
        <main className="flex-grow flex flex-col items-center w-full px-4 sm:px-6 lg:px-8">
          ...
          <div className="w-full max-w-[800px] flex flex-col items-center text-center mb-12">
            ...
            <div className="w-14 h-14 rounded-2xl bg-secondary/10 flex items-center justify-center mb-6">
              <span className="material-icons text-3xl text-secondary">description</span>
            </div>
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Please read these terms carefully before using our service. They outline your rights and obligations as a user of the Wihda platform.
            </p>
          </div>
                ...
                <CardContent className="p-8 sm:p-12 relative">
                    ...
                    <div className="prose prose-slate dark:prose-invert max-w-none text-muted-foreground transition-colors">
                        <section id="introduction" className="mb-12 scroll-mt-32">
                            ...
                            <p className="mb-4">
                            By accessing or using the Wihda platform, you agree to be bound by these Terms. If you disagree with any part of the terms, then you may not access the Service.
                            </p>
                        </section>
                        ...
                        <section id="accounts" className="mb-12 scroll-mt-32">
                            <h3 className="text-2xl font-bold text-foreground mb-4">2. Accounts</h3>
                            <p className="mb-4">
                        ...
                        <section id="content" className="mb-12 scroll-mt-32">
                            <h3 className="text-2xl font-bold text-foreground mb-4">3. Content</h3>
                            <p className="mb-4">
                        ...
                        <section id="termination" className="mb-12 scroll-mt-32">
                            <h3 className="text-2xl font-bold text-foreground mb-4">4. Termination</h3>
                            <p className="mb-4">
