...
export const getHelpCategories = (
...
): HelpCategory[] => [
	{
		...
		label: dict ? dict.HelpCategories.cat1_label : "",
		icon: "rocket_launch",
		description: dict ? dict.HelpCategories.cat1_desc : "",
		href: "/help/getting-started",
	},
	{
		slug: "account",
		label: dict ? dict.HelpCategories.cat2_label : "",
		icon: "person",
		description: dict ? dict.HelpCategories.cat2_desc : "",
		href: "/help/account",
	},
	{
		slug: "civic-participation",
		label: dict ? dict.HelpCategories.cat3_label : "",
		icon: "how_to_vote",
		description: dict ? dict.HelpCategories.cat3_desc : "",
		href: "/help/civic-participation",
	},
	{
		slug: "privacy",
		label: dict ? dict.HelpCategories.cat4_label : "",
		icon: "security",
		description: dict ? dict.HelpCategories.cat4_desc : "",
		href: "/help/privacy",
	},
	{
		slug: "moderation",
		label: dict ? dict.HelpCategories.cat5_label : "",
		icon: "gavel",
		description: dict ? dict.HelpCategories.cat5_desc : "",
...
export const HELP_ARTICLES: HelpArticle[] = [
	...
	},
	{
		...
		description: "Keep your login credentials up to date for security.",
		category: "account",
...
export function getCategoryBySlug(slug: string): HelpCategory | undefined {
	return getHelpCategories(undefined).find((c) => c.slug === slug);
}
