						...
						<div className="flex flex-col sm:flex-row items-center gap-8 w-full justify-center lg:justify-start">
							...
							<div className="flex flex-col gap-3 w-full sm:w-auto">
								<Link href="#" passHref>
									<Button
										size="lg"
										className="h-14 px-8 rounded-xl text-base gap-3 shadow-md hover:translate-y-[-2px] transition-all w-full sm:w-auto justify-start cursor-pointer"
									>
								...
								<Link href="#" passHref>
									<Button
										size="lg"
										variant="secondary"
										className="h-14 px-8 rounded-xl text-base gap-3 shadow-md hover:translate-y-[-2px] transition-all bg-neutral-800 text-white hover:bg-neutral-900 dark:bg-slate-700 dark:hover:bg-slate-600 w-full sm:w-auto justify-start cursor-pointer"
									>
										<span className="material-icons text-3xl">
							...
							<div className="flex items-center gap-1">
								<div className="flex text-yellow-500">
									<span className="material-icons text-sm">
										{dict.DownloadPage.text_15}
									</span>
									<span className="material-icons text-sm">
										{dict.DownloadPage.text_16}
									</span>
									<span className="material-icons text-sm">
										{dict.DownloadPage.text_17}
									</span>
									<span className="material-icons text-sm">
										{dict.DownloadPage.text_18}
									</span>
									<span className="material-icons text-sm">
										{dict.DownloadPage.text_19}
									</span>
								</div>
