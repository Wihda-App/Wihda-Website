...
export const ProblemMission: React.FC = () => {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-24 items-center mb-32 relative">
                    ...
                    <div className="relative z-10 p-4 h-full flex flex-col">
                        <div className="bg-white dark:bg-gray-800 p-3 rounded-xl shadow-lg mt-8 mb-4">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="font-bold text-sm text-gray-900 dark:text-white">Report an Issue</span>
                            </div>
                        </div>
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
                            ...
                            <span className="material-icons text-4xl text-primary drop-shadow-xl">location_on</span>
                        </div>

                        {/* Bottom Sheet */}
                        <div className="mt-auto bg-white dark:bg-gray-800 rounded-xl p-4 shadow-[0_-10px_40px_rgba(0,0,0,0.1)]">
                            <div className="w-10 h-1 bg-gray-300 rounded-full mx-auto mb-4"></div>
                            <h4 className="font-bold text-gray-900 dark:text-white mb-2">Details</h4>
                            ...
                            <button className="w-full bg-primary text-white font-bold py-2 rounded-lg text-sm">Submit Report</button>
                        </div>
                    </div>
                 </div>
             </div>
          ...
          <div className="md:w-1/2 order-1 md:order-2">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 dark:text-white">Reporting Shouldn't Be Hard.</h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
              Traditional ways of engaging with your city are slow and opaque. Paper forms, confusing websites, and endless phone trees discourage action.
            </p>
        ...
        <div className="relative py-16 my-16 text-center border-y border-gray-100 dark:border-gray-800">
          <h3 className="text-2xl md:text-4xl font-bold text-gray-900 dark:text-white leading-tight max-w-3xl mx-auto">
            "Wihda puts the power of <span className="text-primary">city hall</span> directly into the palm of your hand."
          </h3>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-24 items-center">
          <div className="md:w-1/2 pl-4">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 dark:text-white">Results You Can See.</h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
              Track your impact in real-time. Get notified when your reports are fixed, see how your vote changed policy, and earn badges for being an active citizen.
            </p>
            <button className="text-primary font-bold flex items-center gap-2 group">
                Explore Features <span className="material-icons group-hover:translate-x-1 transition-transform">arrow_forward</span>
            </button>
          </div>
                ...
                <div className="relative w-full bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-2xl border-l-4 border-secondary transform translate-y-0">
                    <div className="flex justify-between items-start mb-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h4 className="font-bold text-gray-900 dark:text-white text-sm">Issue Resolved!</h4>
                                <p className="text-xs text-gray-500">2 minutes ago</p>
                            </div>
                        </div>
                    </div>
                    <p className="text-gray-600 dark:text-gray-300 text-sm mb-4">
                        The "Streetlight broken" report you filed has been marked as fixed by the City Council.
                    </p>
                    <div className="w-full bg-gray-50 dark:bg-gray-700 rounded-lg p-3 flex items-center gap-3">
                         <img src="https://images.unsplash.com/photo-1596236987820-213c54452136?auto=format&fit=crop&w=100&q=80" className="w-12 h-12 rounded object-cover" alt="Fixed light" />
                         <span className="text-xs text-gray-500 italic">"Thanks for reporting this!" - Maintenance Team</span>
                    </div>
                </div>
             </div>
          </div>
