    ...
    <section className="py-20 bg-gray-50/50 dark:bg-gray-900/50 border-y border-gray-200 dark:border-gray-800">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">
          Stay Connected with Wihda
        </h2>
        <p className="text-lg text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
          Join our community newsletter for the latest updates on civic tech, community success stories, and platform improvements.
        </p>
        
        <form className="max-w-md mx-auto flex gap-3" onSubmit={(e) => { e.preventDefault(); console.log('Newsletter signup'); }}>
