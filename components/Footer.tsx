        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 rounded-3xl overflow-hidden relative h-80 shadow-2xl">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm px-10 py-8 rounded-2xl text-center max-w-lg mx-4 shadow-xl border border-white/20">
              <p className="text-sm font-bold uppercase tracking-widest text-primary mb-3">Join the movement</p>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Built by people like you.</h2>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 pt-16 pb-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            <div>
              <h4 className="font-bold text-gray-900 dark:text-white mb-4 text-lg">Platform</h4>
            ...
            <div>
              <h4 className="font-bold text-gray-900 dark:text-white mb-4 text-lg">Contact</h4>
              <ul className="space-y-4 text-sm text-gray-600 dark:text-gray-400">
                <li className="flex items-center gap-3">
                  <span className="material-icons text-primary text-xl">mail</span>
                  <a target='_blank' href="mailto:contact@wihdaapp.com" className="hover:text-primary transition-colors">contact@wihdaapp.com</a>
                </li>
                <li className="flex items-start gap-3">
                  <span className="material-icons text-primary text-xl mt-0.5">call</span>
                  <div className="flex flex-col">
                    <a target='_blank' href="tel:+966590386935" className="hover:text-primary transition-colors font-semibold text-gray-900 dark:text-white">+966 590 386 935</a>
                    <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Phone & Telegram</span>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 text-primary mt-1">
                    <svg className="fill-current w-full h-full" viewBox="0 0 24 24">
                  ...
                  <div className="flex flex-col">
                    <a href="https://wa.me/213549599182" target='_blank' className="hover:text-primary transition-colors font-semibold text-gray-900 dark:text-white">+213 549 599 182</a>
            ...
            <div>
              <h4 className="font-bold text-gray-900 dark:text-white mb-4 text-lg">Legal</h4>
              <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="border-t border-gray-100 dark:border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-xl text-gray-900 dark:text-white font-sans">Wihda</span>
            </div>
            <p className="text-sm text-gray-500">© {new Date().getFullYear()} Wihda Inc. All rights reserved.</p>
            <div className="flex space-x-6 items-center">
              <a target='_blank' href="https://www.facebook.com/share/1AxomFTBiT/?mibextid=wwXIfr" className="text-gray-400 hover:text-primary transition-all hover:scale-110" aria-label="Facebook">
                <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a  target='_blank' href="https://www.instagram.com/wihda.app" className="text-gray-400 hover:text-primary transition-all hover:scale-110" aria-label="Instagram">
                <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
              ...
              <a target='_blank' href="https://www.linkedin.com/company/wihda" className="text-gray-400 hover:text-primary transition-all hover:scale-110" aria-label="LinkedIn">
                <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
