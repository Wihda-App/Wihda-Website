					...
					<div className="flex items-center justify-between p-4 border-b border-[#e0dedb]">
						<div className="flex items-center gap-3">
							<div className="text-[#37322f] font-semibold">
								{dict.DashboardPreview.text_1}
							</div>
							<div className="w-2 h-2 bg-green-500 rounded-full"></div>
							<span className="text-sm text-[#605a57]">
								{dict.DashboardPreview.text_2}
							</span>
						</div>
						...
						<div className="flex-1 p-6">
							...
							<div className="bg-white border border-[#e0dedb] rounded-lg overflow-hidden">
								<div className="grid grid-cols-6 gap-4 p-4 bg-[#fbfaf9] border-b border-[#e0dedb] text-sm font-medium text-[#605a57]">
									<div>{dict.DashboardPreview.text_6}</div>
									<div>{dict.DashboardPreview.text_7}</div>
									<div>{dict.DashboardPreview.text_8}</div>
									<div>{dict.DashboardPreview.text_9}</div>
									<div>{dict.DashboardPreview.text_10}</div>
									<div>{dict.DashboardPreview.text_11}</div>
								</div>
								...
								{Array.from({
									...
									>
										<div className="flex items-center gap-2">
											...
											<span>{dict.DashboardPreview.text_12}</span>
										</div>
										<div>
											<span
										...
										<div className="text-[#605a57]">
											{dict.DashboardPreview.text_13}
										</div>
										<div className="font-medium">
											{dict.DashboardPreview.text_14}
										</div>
										<div className="text-[#605a57]">
											{dict.DashboardPreview.text_15}
										</div>
										<div className="text-[#605a57]">
											{dict.DashboardPreview.text_16}
										</div>
									</div>
								))}
							</div>
