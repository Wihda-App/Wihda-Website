        ...
        <div className="flex flex-col items-center gap-12">
          ...
          <div className="max-w-[937px] flex flex-col items-center gap-3">
            <div className="flex flex-col items-center gap-6">
              <div className="inline-block px-4 py-2 rounded-full bg-[#d4e8c1]/40 border border-[#a8d583]/30 mb-2">
                <span className="text-[#2d5016] text-sm font-medium">Join your community today</span>
              </div>
              <h1 className="max-w-[748px] text-center text-[#1a3a0a] text-5xl md:text-[80px] font-normal leading-tight md:leading-[96px] font-sans">
                Build a cleaner, stronger neighborhood
              </h1>
              <p className="max-w-[506px] text-center text-[#2d5016]/80 text-lg font-medium leading-7">
                Connect with your community to share leftovers, organize cleanups, and make a real impact on local campaigns.
              </p>
            </div>
          </div>
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            ...
            <Link href="/simulation">
              <Button variant="outline" className="h-10 px-8 border-[#2d5016] text-[#2d5016] hover:bg-[#2d5016]/5 rounded-full font-medium text-sm transition-all bg-transparent">
