...
const PARTNERS: Partner[] = [
  {
    name: 'Code for MENA',
    logo: 'https://codeformena.org/wp-content/uploads/2025/06/Code-For-MENA-01.svg',
  ...
  },
  {
    ...
    logo: 'https://codeformena.org/wp-content/uploads/2025/07/Untitled-1-01-13a.png',
    ...
    <section className="py-16 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Trusted By</h2>
