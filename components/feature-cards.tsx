export function FeatureCards() {
  ...
  return (
    <section className="border-t border-[#a8d583]/30 border-b border-[#a8d583]/30">
          ...
          {features.map((feature, index) => (
            <div
              ...
              className={`p-6 flex flex-col gap-2 ${
                feature.highlighted ? "bg-white border border-[#a8d583]/50 shadow-sm" : "border border-[#a8d583]/30"
              }`}
            >
              {feature.highlighted && (
