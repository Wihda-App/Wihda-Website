      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-end mb-12">
          <h2 className="text-4xl md:text-6xl font-bold tracking-tight text-neutral-dark dark:text-white">
            Community<br />
            <span className="text-wihda-blue italic">in motion</span>
          </h2>
          <Link 
            href="/blog" 
          ...
          >
            View All Stories <span className="material-icons text-sm">arrow_forward</span>
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-3 gap-4 h-auto md:h-[800px]">
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 p-6 text-white">
              ...
              <h3 className="text-2xl font-bold">Bridging the gap between digital & physical.</h3>
            </div>
          </Link>
          ...
          <Card className="bg-wihda-blue text-white p-8 rounded-xl border-none flex flex-col justify-between hover:bg-wihda-blue/90 transition-colors shadow-sm">
            <div>
              <span className="material-icons text-4xl mb-4 opacity-80">groups</span>
              <h3 className="text-lg font-medium opacity-90">Active Communities</h3>
            </div>
            <div>
              <span className="text-5xl font-black tracking-tighter">1k+</span>
              <p className="text-sm opacity-70 mt-1">Growing daily across 40 cities.</p>
            </div>
          </Card>
          ...
          >
            ...
            <div className="absolute bottom-6 left-6 text-white">
              <p className="text-lg font-bold">Community Hubs</p>
            </div>
          </Link>
          ...
          <Card className="bg-background-light border border-gray-200 dark:border-white/10 dark:bg-white/5 p-8 rounded-xl flex flex-col justify-center items-center text-center hover:border-wihda-green transition-colors group  shadow-none">
            ...
            <h3 className="text-xl font-bold mb-2 text-neutral-dark dark:text-white">Volunteer</h3>
            <p className="text-sm opacity-60 text-neutral-dark dark:text-white/60">Find local causes that need your spark.</p>
          </Card>
          ...
          >
            ...
            <div className="absolute inset-0 p-8 flex flex-col justify-center items-start text-white">
              <h3 className="text-3xl font-bold mb-2">New Civic<br />Framework.</h3>
              <div 
                className="text-sm font-bold border-b border-white pb-1 hover:text-wihda-green hover:border-wihda-green transition-colors mt-4"
              >
          ...
          <Link href="/download" className="block h-full">
            <Card className="relative h-full bg-gradient-to-br from-wihda-green to-[#a3d95b] border-none p-8 rounded-xl flex flex-col justify-between overflow-hidden group cursor-pointer shadow-sm">
              ...
              <h3 className="text-neutral-dark text-2xl font-bold leading-tight relative z-10">Start your own<br />local chapter.</h3>
              <div className="flex justify-between items-end relative z-10">
                <span className="text-neutral-dark font-medium text-sm">Get the toolkit</span>
