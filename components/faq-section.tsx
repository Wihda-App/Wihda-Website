      ...
      <div className="flex-1 px-4 md:px-12 py-16 md:py-20 flex flex-col lg:flex-row justify-start items-start gap-6 lg:gap-12">
        ...
        <div className="w-full lg:flex-1 flex flex-col justify-center items-start gap-4 lg:py-5">
          ...
          <div className="w-full text-[#2d5016]/70 text-base font-normal leading-7 font-sans">
            Have questions about Wihda? Find answers here.
          </div>
        </div>
        ...
        <div className="w-full lg:flex-1 flex flex-col justify-center items-center">
          <div className="w-full flex flex-col">
            {faqData.map((item, index) => {
              ...
              return (
                <div key={index} className="w-full border-b border-[#a8d583]/30 overflow-hidden">
                  <button
                    onClick={() => toggleItem(index)}
                    className="w-full px-5 py-[18px] flex justify-between items-center gap-5 text-left hover:bg-[#d4e8c1]/10 transition-colors duration-200"
                  ...
                  >
                    ...
                    <div className="flex justify-center items-center">
                      <ChevronDownIcon
                        className={`w-6 h-6 text-[#2d5016]/60 transition-transform duration-300 ease-in-out ${
