      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-24 max-w-3xl mx-auto">
          ...
          <p className="text-lg md:text-xl opacity-70">
            Experience the Wihda ecosystem. From neighbor-to-neighbor help to earning rewards for your impact.
          </p>
        </div>
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-center gap-32 md:gap-0 mt-16 md:mt-0">
          ...
          <div className="relative md:absolute md:left-0 md:top-1/2 md:-translate-y-1/2 md:translate-x-12 z-20 group perspective-1000">
            ...
            <div className="absolute -bottom-24 left-1/2 -translate-x-1/2 md:bottom-auto md:-top-12 md:-left-12 md:translate-x-0 bg-white/90 dark:bg-neutral-dark/90 backdrop-blur p-4 rounded-xl border border-secondary shadow-lg max-w-[180px] text-center md:text-left">
              <p className="text-xs font-bold text-secondary uppercase tracking-widest mb-1">Neighbor to Neighbor</p>
              <p className="text-sm font-sans leading-tight">Ask for help or share resources instantly.</p>
            </div>
          </div>
          ...
          <div className="relative z-30 transform md:-translate-y-12">
            ...
            <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 bg-neutral-dark text-white px-6 py-3 rounded-full shadow-xl whitespace-nowrap z-40">
              <span className="font-bold">Join Activities</span> • <span className="opacity-70 text-sm">Real-time Feed</span>
            </div>
          </div>
          ...
          <div className="relative md:absolute md:right-0 md:top-1/2 md:-translate-y-1/2 md:-translate-x-12 z-20 group perspective-1000">
            ...
            <div className="absolute -bottom-24 left-1/2 -translate-x-1/2 md:-bottom-12 md:-right-4 md:left-auto md:translate-x-0 bg-white/90 dark:bg-neutral-dark/90 backdrop-blur p-4 rounded-xl border border-primary shadow-lg max-w-[180px] text-center md:text-right">
              <p className="text-xs font-bold text-primary uppercase tracking-widest mb-1">Impact Economy</p>
              <p className="text-sm font-sans leading-tight">Earn points for every good deed.</p>
            </div>
          </div>
        </div>
